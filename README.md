...
|---------------|------|------|-------------|
| **Product Analytics Micro-Certification (Mixpanel x Product School)** | 2025 | <a href="https://productschool.teachable.com/courses/1373833/certificate" target="_blank">View</a> | Learned product analytics fundamentals including event tracking, funnels, retention analysis, cohort insights, and data-driven product decision-making using Mixpanel. |
